...
async (conn, mek, m, { from, quoted, reply }) => {
    try {
        ...
        let envSettings = `╭━━━〔 *LADLA-MALIK-MD* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *ENV SETTINGS 🗿*
┃▸└───────────···๏
╰────────────────┈⊷
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: 'https://i.ibb.co/YXRsD6K/mrfrankofc.jpg' }, // Image URL
                caption: envSettings,
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: '120363282589853707@newsletter',
                        newsletterName: "Ladla-Malik",
                        serverMessageId: 143
                    }
                }
            },
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/ladla-malik/Ladla-Malik-Main/raw/refs/heads/main/autovoice/menunew.m4a' }, // Audio URL
            mimetype: 'audio/mp4',
            ptt: true
        }, { quoted: mek });
